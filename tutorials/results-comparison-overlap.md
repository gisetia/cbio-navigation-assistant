...
* **Creating New Groups:** You can **click on one or more sections** of the Venn/UpSet diagram (e.g., the intersection area, or an area exclusive to one group) to select that subset of samples and create a **new custom group** from those areas by clicking on **Create Group From Selected Diagram Areas**.
